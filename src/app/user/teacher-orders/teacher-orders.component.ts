...
@Component({
  selector: 'app-teacher-orders',
  templateUrl: './teacher-orders.component.html',
  styleUrls: ['./teacher-orders.component.css']
})
export class TeacherOrdersComponent implements OnInit {
  userDetailsother;
  userDetails;
  orders;
  currentorder;
...
showBasicDialog2(order) {
  ...
  console.log(order.sendermail);
  this.createInbox(order.sendermail);
}
