...
{}
    ...
    getdatetime()
    {
      ...
      if (this.selectedPackage=='Basic'){this.currentamount=this.currentcource.basicprice;this.nbhours=this.currentcource.basichours;this.newprice=this.currentcource.basicprice-(this.currentcource.basicprice*10/100);}
      else if (this.selectedPackage=='Standard'){this.currentamount=this.currentcource.standardprice;this.nbhours=this.currentcource.standardhours;this.newprice=this.currentcource.standardprice-(this.currentcource.basicprice*10/100);}
      else {this.currentamount=this.currentcource.premiumprice;this.nbhours=this.currentcource.premiumhours;this.newprice=this.currentcource.basicprice-(this.currentcource.basicprice*10/100);}
